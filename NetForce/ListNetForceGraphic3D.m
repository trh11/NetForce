...
BeginPackage["ListNetForceGraphic3D`"];

ListNetForceGraphic3D::usage="ListNetForceGraphic3D[{{\!\(\*SubscriptBox[
StyleBox[\"F\", \"TI\"], 
...
ListNetForceGraphic3D[Nforces__]:=
Module[
{F,\[Theta],\[Phi],\[ScriptM],Fx,Fy,Fz,forces=Nforces,components,sumx,sumy,sumz,tops,FN,\[Theta]N,\[Phi]N},
Column[{
Grid[
{
